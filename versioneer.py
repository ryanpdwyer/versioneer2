...
__version__ = '0.1.1.post0.dev0_dirty-py2.7.egg'
...
LONG_VERSION_PY['git'] = string.Template('''
...
# versioneer2-$version (https://github.com/ryanpdwyer/versioneer2)
...
SHORT_VERSION_PY = string.Template("""
# This file was generated by 'versioneer.py' ($version) from
    ...
    class cmd_build_exe(_build_exe):
        def run(self):
            ...
            with open(versionfile_source, "w") as f:
                assert VCS is not None, "please set versioneer.VCS"
                LONG = LONG_VERSION_PY[VCS](version=__version__)
                f.write(LONG % {"DOLLAR": "$",
...
class cmd_sdist(_sdist):
    ...
    def make_release_tree(self, base_dir, files):
        ...
        os.unlink(target_versionfile)
        with open(target_versionfile, "w") as f:
            f.write(SHORT_VERSION_PY(version=__version__) % self._versioneer_generated_versions)
